...
//		lp.loginToApp(Username, Password);
		...
		// Step 4: Create Organization with Industry and Type and Save
		CreateNewOrganizationPage cnop = new CreateNewOrganizationPage(driver);
		cnop.createNewOrganization(organizationName, industryName, typeName);
		Reporter.log("Create Organization with Industry and Type and Save");
...
//		if ((actualIndustry.contains(industryName)) && (actualType.contains(typeName)))
//			System.out.println(actualIndustry + "-" + actualType + "-" + "TestCase Passed");
//		else
//			System.out.println(actualIndustry + "-" + actualType + "-" + "TestCase Failed");
		Assert.assertTrue(actualIndustry.contains(industryName));
		Assert.assertTrue(actualType.contains(typeName));
		Reporter.log("Validate industry and type drop down");
